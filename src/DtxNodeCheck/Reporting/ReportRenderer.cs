...
internal static class ReportRenderer
{
    ...
    private static string RenderText(CheckRun run)
    {
        ...
        builder.AppendLine("DTX Studio Clinic Node Check");
        builder.AppendLine("============================");
    ...
    {
        var builder = CreateHtml("DTX Node Check Report");
        builder.AppendLine("<main>");
        builder.AppendLine("<h1>DTX Node Check Report</h1>");
    ...
    {
        var builder = new StringBuilder();
        builder.AppendLine("DTX Studio Clinic PC Inventory");
        builder.AppendLine("==============================");
        builder.AppendLine($"Started at: {run.StartedAt:O}");
    ...
    {
        var builder = CreateHtml("DTX Node Check Inventory");
        builder.AppendLine("<main>");
        builder.AppendLine("<h1>DTX Node Check Inventory</h1>");
        builder.AppendLine("<section class=\"summary\">");
        builder.AppendLine($"<div><strong>Started</strong><span>{Html(run.StartedAt.ToString("O"))}</span></div>");
